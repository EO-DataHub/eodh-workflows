...
from eodh_workflows.workflows.spectral.functional import (
    cdom,
    chl_a_coastal,
    chl_a_high,
    chl_a_low,
...
from eodh_workflows.workflows.spectral.utils import raster_stats, rescale, resolve_rescale_params
