...
from eodh_workflows.utils.raster import get_raster_polygon, save_cog_v2
from eodh_workflows.utils.stac import read_local_stac, write_local_stac
from eodh_workflows.workflows.legacy.lulc.helpers import get_classes
...
def _get_shares_for_classes(input_data: xarray.DataArray, unique_values: set[int]) -> dict[int, float]:
    ...
    counts_dict = {
        int(value): float(count / data.size) * 100
